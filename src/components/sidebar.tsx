...
export function Sidebar() {
  ...
  return (
    <aside className="flex flex-col h-screen border-r border-[var(--border-color)] bg-[var(--bg-sidebar)] select-none">
      ...
      >
        <span className="text-xs font-medium uppercase tracking-wider text-[var(--text-secondary)] pointer-events-none">Projects</span>
        <button
      ...
      <div ref={listRef} className="flex-1 overflow-y-auto py-1">
        {projects.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full px-4 text-center">
            <FolderPlus
              size={28}
              className="mb-2 text-[var(--text-tertiary)]"
            />
      ...
      <div data-onboarding="sidebar-footer" className="flex items-center justify-center gap-1 px-2 py-2 border-t border-[var(--border-color)]">
